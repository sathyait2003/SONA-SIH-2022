<?php
                    ...
                    if(true){
                        ...
                        $sql= "SELECT * FROM technvxg_pratikriya_vishleshan.faculty_feedinfo WHERE college_id='$college_id' AND course_id='$course_id';";
                        ...
                        $sql2= "SELECT * FROM technvxg_pratikriya_vishleshan.faculty_feedback WHERE faculty_id='$faculty_id' AND feedback_id='$feedback_id';";
                        ...
                        if(isset($_POST['submit'])){
                            ...
                            $data="INSERT INTO technvxg_pratikriya_vishleshan.faculty_feedback VALUES ('$filling_date','$faculty_id','$Q1','$Q2','$Q3','$Q4','$Q5','$feedback_id');";
                            $con->query($data);
