<?php
      ...
      if(isset($_POST['submit'])){
        ...
        //   $course_id="BTech_CSE";
          ...
          $data = "INSERT INTO technvxg_pratikriya_vishleshan.alumini VALUES('$college_id','$alumini_id','$course_id','$fullname','$email','$batch');";
    ...
    <div class="page">
      ...
      <section class="py-5">
        <div class="container-fluid">
            ...
            <div class="row">
                <form class="row g-0 needs-validation" action="./csv_import_alumini.php" method="post" novalidate>
                    <div>
                    <p>***To enter the list of all Student in respective format(Firstname, Lastname, email, Mobile number,Program name, Department,Birth-date)***</p>
                    </div>
                    <div class="mb-3">
