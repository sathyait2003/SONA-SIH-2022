<?php
                    ...
                    if(isset($_POST['submit'])){
                        ...
                        $sql= "SELECT * FROM technvxg_pratikriya_vishleshan.login_cred WHERE role = '$role' AND username = '$username' AND password = '$password';";
                        ...
                        if($result and $dbrole=='HEI'){
                          ...
                          $sql2= "SELECT * FROM technvxg_pratikriya_vishleshan.student WHERE email = '$username' AND college_id = '$college_id';";
...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="All_India_Council_for_Technical_Education_logo-removebg-preview.png" />
...
<body>
    <div class="mainflex">
        ...
        <form class="mainflex-2" action="" method="post">
            ...
            <option value="HEI">Head Of Institute</option>
            <option value="HOD">HOD</option>
            <option value="Faculty">Faculty</option>
            <option value="Student">Student</option>
          </select>
                <input class="login-flex" type="email" id="mail" aria-describedby="emailHelp" placeholder="Enter email" name="email" />
                <input class="login-flex" type="password" id="Pass" placeholder="Password" name="password" />
