    ...
    <div class="page">
        ...
        <section class="py-5">
            <div class="container-fluid">
                ...
                <div class="row">
                    <form class="row g-0 needs-validation" action="./csv_impot_employer.php" mthod="post" novalidate>
                        <div>
                            <p>***To enter the list of all Employer in respective format(Name,Designation,Email,Mobile number)***</p>
                        </div>
                        <div class="mb-3">
                ...
                <div class="row">
                    <form>
                        ...
                        <!-- <div class="mb-3">
                            <label for="phone" class="form-label">Mobile no.(+91)</label>
                            <input type="tel" class="form-control" pattern="[0-9]{10}" name="mobile" required>
                        </div> -->
                    ...
                    <?php
                        ...
                        if(isset($_POST['submit'])){
                            ...
                            $data = "INSERT INTO technvxg_pratikriya_vishleshan.employer VALUES('$employer_id','$fullname','$des','$email','$college_id','$fullname');";
                            // $data1 = "INSERT INTO technvxg_pratikriya_vishleshan.login_cred(`role`, `college_id`, `username`, `password`) VALUES ('$role','$college_id','$email','$mobile');";
