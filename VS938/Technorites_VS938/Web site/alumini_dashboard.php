...
<body>
                ...
                <div class="form_questions">
                    <div class="form-control">
                        <label class="question">
                            1. How do you find overall infrastructure at the Institute?
                        </label>
                        <div class="radio_">
                    ...
                    <div class="form-control">
                        <label class="question">
                            2. How do you rate Syllabus in preparing you for a Job/Higher
                            Studies?
                        </label>
                        <div class="radio_">
                    ...
                    <div class="form-control">
                        <label class="question">
                            3. Do you feel the existing curriculum/syllabus fulfil the
                    ...
                    <div class="form-control">
                        <label class="question">
                            4.Did you attend industry training/internship to prepare for
                            industry job?
                        </label>
                        <div class="radio_">
                    ...
                    <div class="form-control last_question">
                        <label class="question">
                            5. Rate the various curricular, co-curricular and extra-curricular
                            activities, during your course of study, in the Institute.
                        </label>
                        <div class="radio_">
    ...
    <script>
        ...
        // pls don't forPOST to change to your domain :)
...
<!-- 
    <script>
        ...
        var textChoice = ["Poor", "Below Average", "Average", "Good", "Exellent"];
        function feedbackValue(typeId, questionId) {
            document.POSTElementById(`feedbackQuestion${typeId}`).innerHTML =
                textChoice[questionId - 1];
            document.POSTElementById(`feedbackQuestion${typeId}`).style.color =
                colorChoice[questionId - 1];
            document.POSTElementById(`feedbackQuestion${typeId}`).style.textShadow =
                shodowChoice[questionId - 1];
        }
    </script> -->
...
//   $url = parse_url($q);
//   parse_str($url['query'], $para);
//   $feed_id = $para['feed_id'];
//   $alu_id = $para['alu_id']; 
  $feed_id=$alu_id=null;
  ...
  if(isset($_POST['submit']))
  {
    ...
    //   $alu_id =  2;
      ...
      $Q4 =  $_POST['question_4'];
      $Q5 =  $_POST['question_5'];
      $sql= "INSERT INTO alumini_feedback values('$feed_id','$filling_date','$alu_id',$Q1,$Q2,$Q3,$Q4,$Q5)";
      $con->query($sql);
      echo "success";
      $con->close();                      
  }
